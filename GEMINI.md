...
- **Execution Rule**: Do NOT execute long PowerShell inspection scripts directly via inline `powershell -Command @"..."`. Write to `temp_inspect.ps1` and run `powershell -ExecutionPolicy Bypass -File temp_inspect.ps1`.
- **Build & Package**:
